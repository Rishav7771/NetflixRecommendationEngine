...
2. Install all the libraries mentioned in the [requirements.txt](https://github.com/Rishav7771/NetflixRecommendationEngine) file with the command `pip install -r requirements.txt`
